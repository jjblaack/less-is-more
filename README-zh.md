...
一套为 **Claude Code** 打造的个人 AI 协同开发 harness。两条路，一个理念：**用最少的约束，达成最大的掌控力**。
...
Claude Code 很强。但如果没有工作流约束，你会收到一堆不是你想要的代码。反过来，规则太多呢？你花在管理 agent 上的时间，可能比写代码还多。
...
AI 时代，**品味是分水岭**。谁都能生成代码。真正的差距在理解深度：知道该保留什么、该砍掉什么、为什么。
...
- **越用越聪明** —— 每次 session 结束自动提醒你记录踩坑经验。几周下来，一份个人知识库就成型了。
